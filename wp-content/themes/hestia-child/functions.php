...
function add_hestia_child_theme_the_header_content() {
  ...
  <nav class="navbar navbar-default navbar-fixed-top <?php echo esc_attr( $navbar_class ); ?>">
    ...
    <div class="entry-social">
      <a target="_blank" href="https://www.facebook.com/evehoyt"><i class="fa fa-facebook"></i></a>
      <a target="_blank" rel="tooltip" href="https://www.instagram.com/eveningneon/"><i class="fa fa-instagram"></i></a>
    </div>
    <div class="container">
